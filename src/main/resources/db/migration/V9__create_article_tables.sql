...
CREATE TABLE article (
    ...
    likes INT NOT NULL,
    shares INT NOT NULL,
    visibility_level DOUBLE PRECISION NOT NULL,
    impact_modifier DOUBLE PRECISION NOT NULL,
...
CREATE TABLE article_bias (
    ...
    emotional_charge_score DOUBLE PRECISION,
    misleading_language_score DOUBLE PRECISION,
    suggested_tags TEXT,
    analysis_notes TEXT,
